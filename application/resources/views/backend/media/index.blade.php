...
@section('content')
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                     <form method="POST" enctype="multipart/form-data" class="uploadform" action="<?php echo route('backend_media_store_noajax'); ?>" >
                        @csrf
                        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="product-images col-md-2 col-3" style="background: #f2f2f2;">
                            <a href="{{asset('/public/uploads/images/').'/'. $item->filename}}" data-toggle="lightbox" data-title="{{$item->filename}}" data-gallery="gallery">
                                ...
                                <a href="{{route('backend_media_delete', $item->id)}}" onclick="return confirm('Are you sure want to Delete?')" class="remove"><span class="fa fa-trash"></span></a>
                            </a>
                        </div>
                        @endforeach
                    </div>
